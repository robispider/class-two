...
targetSprite.active=false;     
    ...
    showIntroStory() {
        ...
        // Story Text
        const storyText = "হ্যালো আমি  আর্মি স্পাই ক্যাপটেন মিনা\n\nশত্রুপক্ষের গুপ্তচর বিমান রাডার ফাঁকি দিয়ে বন্ধু বিমানের বেশে দেশের ভেতরে ঢুকে পড়েছে! প্রতিটি বিমানে রয়েছে মারাত্মক বিষাক্ত গ্যাস।\n\nআপনার মিশন: স্ক্রিনে দেখানো টার্গেট কোড মিলিয়ে সঠিক বিমানটি ধ্বংস করা। মাতৃভূমির আকাশ রক্ষার দায়িত্ব এখন আপনার কাঁধে!";
